...
<img src="https://sutianhua-markdowm-image.oss-cn-guangzhou.aliyuncs.com/2025202501161643210.png" style="zoom:50%;" />
...
4. 初始化vpnService服务(首先上传key.json文件到/root目录 然后修改vpnService的配置信息)
